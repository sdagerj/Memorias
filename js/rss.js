...
export async function fetchHeadlines(sources, maxPerSource = 5) {
  const results = [];
...
export const DEFAULT_SOURCES = [
  ...
  { id: 'semana',       name: 'Semana',              url: 'https://www.semana.com/rss/',                                                       category: 'general',   active: false },
  { id: 'dinero',       name: 'Dinero',              url: 'https://www.dinero.com/rss/home.xml',                                              category: 'economía',  active: false },
  { id: 'eltiempo',     name: 'El Tiempo',           url: 'https://www.eltiempo.com/rss/economia.xml',                                        category: 'economía',  active: false },
];
