...
export function Alfabetico({ alTerminar, velocidadVoz, voz, usarMicrofono }: PropsEjercicio) {
  ...
  return (
    <Tarjeta className="text-center">
      <h2 className="text-xl font-semibold">En orden alfabético</h2>
        ...
        {fase === 'respondiendo' && (
          <div className="w-full">
            <textarea
              ...
              className="w-full resize-none rounded-suave border border-borde bg-fondo px-4 py-3 text-center text-lg"
            />
